...
export const LoginScreen = () => {
  ...
  const onLogin = (form_state) => {
    const email = form_state[FORM_FIELDS.EMAIL].trim();
    const password = form_state[FORM_FIELDS.PASSWORD].trim();
    ...
    // ✅ Solo envío si pasó validaciones
  ...
  const { form_state: login_form_state, handleSubmit, handleInputChange } =
    useForm({
      initial_form_state,
      onSubmit: onLogin,
    });
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            ...
            <input
              ...
              disabled={!!response}
              autoComplete="off" // 🔒 bloquea autocompletado
            />
          </div>
          ...
          {!response ? (
            ...
            <>
              <button className="login-btn success" type="button" disabled>
                <svg
